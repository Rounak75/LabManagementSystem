...
export const PANEL_TESTS: Seed[] = [
  ...
  { name: "Lipid Profile", category: "Blood", price: 600, parameters: [
  ...
  { name: "Liver Function Test (LFT)", category: "Blood", price: 700, parameters: [
  ...
  { name: "Kidney Function Test (KFT)", category: "Blood", price: 700, parameters: [
  ...
  { name: "Thyroid Profile (T3/T4/TSH)", category: "Blood", price: 500, isOutsourced: true, parameters: [
  ...
  { name: "ESR", category: "Blood", price: 100, parameters: [
